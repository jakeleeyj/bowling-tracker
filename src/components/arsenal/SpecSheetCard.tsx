...
const SpecSheetCard = forwardRef<
  HTMLDivElement,
  { draft: BallDraft; ballImage?: string }
>(function SpecSheetCard({ draft, ballImage }, ref) {
  ...
  return (
    ...
    >
      ...
      {/* charts stacked on dark panels so app colors stay legible on paper */}
      {hasLayout && (
        <div
          style={{
            background: "#0f1729",
        ...
        >
          {ballImage ? (
            // the live 3D render captured from the ball page
      ...
      >
        <GripChart draft={draft} maxWidth={560} />
      </div>
